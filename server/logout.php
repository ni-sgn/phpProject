<?php
	if(isset($_COOKIE['id']))
	{
		...
		//error accures here too! doesn't change cookie here
		//echo "after: ".$_COOKIE["id"];
...
<circle fill="#130f40" cx="86.238" cy="57.885" r="6.667"/>
<circle fill="#c3253d" cx="40.072" cy="57.885" r="6.667" onclick="kliku()"/>
...
<path fill="#ffff9b" stroke="#FEEBE6" stroke-miterlimit="10" d="M116.279,55.814c-0.021-0.286-2.323-28.744-30.221-41.012
  ...
  <p class="shadowFrame"><svg version="1.1" class="shadow" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="61px" y="20px"
	 ...
	 xml:space="preserve">
<ellipse fill="#c3073f" cx="61.128" cy="19.872" rx="49.25" ry="8.916"/>
    </svg></p>
    <!--End of animation for shadow-->
